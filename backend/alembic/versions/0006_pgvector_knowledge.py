...
def upgrade():
    ...
    op.create_index("ix_knowledge_documents_policy_number","knowledge_documents",["policy_number"])
...
def downgrade():
    ...
    for n in ["ix_knowledge_documents_effective_to","ix_knowledge_documents_effective_from","ix_knowledge_documents_policy_number","ix_knowledge_documents_insurance_type","ix_knowledge_documents_document_type"]:
